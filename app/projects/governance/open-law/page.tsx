...
export default function LawFrameworkPage() {
  ...
  const laws: Laws = {
    'env-protection-act': {
      ...
      goals: [
        {
          goal: 'Reduce carbon emissions by 30%',
        ...
        {
          goal: 'Increase renewable energy usage',
        ...
        {
          goal: 'Protect 5000 acres of forest',
          metric: 'Protected land',
          target: '5000 acres',
          current: '4200 acres',
          status: 'near-target',
        },
      ...
      amendments: [
        {
          id: 'EPA-A1',
          title: 'Solar Incentives Amendment',
          date: '2023-06-10',
          sponsor: 'Rep. Johnson',
          status: 'approved',
        },
        {
          id: 'EPA-A2',
          title: 'Corporate Emissions Reporting',
          date: '2023-07-22',
          sponsor: 'Rep. Garcia',
          status: 'pending',
        },
    ...
    'digital-privacy-act': {
      ...
      goals: [
        {
          goal: 'Secure personal data protection',
        ...
        {
          goal: 'Increase transparency in data collection',
          metric: 'Compliance rate',
          target: '95% of companies',
          current: '78% of companies',
          status: 'in-progress',
        },
        {
          goal: 'Enforce right to be forgotten',
          metric: 'Request fulfillment rate',
          target: '99% fulfilled',
          current: '94% fulfilled',
          status: 'near-target',
        },
      ],
      amendments: [
    ...
    'small-business-act': {
      ...
      goals: [
        {
          goal: 'Increase small business formation',
          metric: 'New business registrations',
          target: '25% increase',
          current: '13% increase',
          status: 'in-progress',
        },
        {
          goal: 'Improve access to capital',
      ...
      amendments: [
        {
          id: 'SBA-A1',
          title: 'Minority Business Focus',
          date: '2023-04-12',
          sponsor: 'Rep. Washington',
          status: 'approved',
        },
        {
          id: 'SBA-A2',
          title: 'Rural Enterprise Incentives',
          date: '2023-08-05',
          sponsor: 'Rep. Miller',
          status: 'pending',
        },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href={{ pathname: '#demo' }}
                  className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md bg-white text-amber-700 hover:bg-amber-50"
                >
                  Explore Active Laws
                </Link>
                <Link
                  href={{ pathname: '#benefits' }}
                  className="inline-flex items-center justify-center px-5 py-3 border border-amber-400 text-base font-medium rounded-md text-white hover:bg-amber-700"
                >
                  See the Impact
                </Link>
              </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center text-amber-800 font-bold text-xl mb-4">
                1
              </div>
              ...
              <div className="flex justify-center mb-6">
                <div className="flex -space-x-2">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1491349174775-aaafddd81942?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=150&q=80"
                    alt=""
                  />
                  <img
                    className="inline-block h-12 w-12 rounded-full ring-2 ring-white"
