...
/**
 * Exported so the liveness probe can write into the SAME tracker the real chat
 ...
 */
export const llmHealthTracker = createHealthTracker({
  downAfter: DOWN_AFTER_CONSECUTIVE_FAILURES,
});
